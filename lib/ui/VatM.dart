import 'package:almaskan/ui/Vat2.dart';
...
class Vatm extends StatefulWidget {
  const Vatm({super.key});

  @override
  State<Vatm> createState() => _VatmState();
}

class _VatmState extends State<Vatm> {
  ...
  Widget container() {
    final firestore = FirebaseFirestore.instance.collection('Vat');
    return Padding(
  ...
  Widget build(BuildContext context) {
    final firestore = FirebaseFirestore.instance.collection('Vat').snapshots();
    return Scaffold(
      body: Stack(
        children: [
